...
const MapLocations = () => {
    ...
    useEffect(() => {
        (async () => {
            ...
            const citylocation = await axios.get("https://maps.googleapis.com/maps/api/place/textsearch/json?query=angole+Luanda&key=AIzaSyBCZVSjuVPDGigu-jFRtmV6p8fVXtlOxyc");
            data1 = [...data1, ...data2];
            const citynames:any = [""];
            ...
            // try {
            //     let LocalStorageKey:string = "cityData";
            //     await AsyncStorage.setItem(LocalStorageKey, citynames);
